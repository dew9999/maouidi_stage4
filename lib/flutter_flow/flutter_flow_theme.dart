...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF11A381);
  late Color secondary = const Color(0xFF1C333C);
  late Color tertiary = const Color(0xFF1C333C);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF1C333C);
  ...
  late Color customColor1 = const Color(0xFF9FAACC);
  late Color customColor2 = const Color(0xFF40FFDE);
  late Color customColor3 = const Color(0xFF074B9F);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF11A381);
  late Color secondary = const Color(0xFF11A381);
  late Color tertiary = const Color(0xFF11A381);
  late Color alternate = const Color(0xFF262D34);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFF1C333C);
  late Color secondaryBackground = const Color(0xFF234551);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
