// lib/flutter_flow/flutter_flow_calendar.dart
...
DateTime _previousWeek(DateTime week) => week.subtract(const Duration(days: 7));
DateTime _nextWeek(DateTime week) => week.add(const Duration(days: 7));
